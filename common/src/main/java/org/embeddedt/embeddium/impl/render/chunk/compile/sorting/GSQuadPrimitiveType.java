...
// TODO: [VEN][GEO-NEO-AO] There is something I must have missed in this implementation, it causes flickering
public class GSQuadPrimitiveType implements ChunkPrimitiveType {
    public static final GSQuadPrimitiveType INSTANCE = new GSQuadPrimitiveType();
